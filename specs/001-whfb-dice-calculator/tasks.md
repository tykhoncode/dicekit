...
- [x] T009 [P] Add WHFB 8th Edition charts in `src/entities/dice/lib/charts.ts` — `TO_HIT_CHART` and `TO_WOUND_CHART` as `as const` 10×10 readonly arrays per `research.md` §1.1, §1.2 (depends on T008 for the literal-union value type).
