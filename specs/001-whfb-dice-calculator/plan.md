...
| --- | -------------------------------------------------------- | ------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| I   | Visual Fidelity & Reference-Driven UI                    | ✅ Pass | Reference image at `.artifacts/screenshots/image.png`. SC-007 mandates structural parity (regions, ordering, grouping). Pixel parity is not required — Inter is the bundled font (FR Assumptions).                                                                                                                                                                                                                                                                                                                                                                                             |
...
.artifacts/
└── screenshots/
    └── image.png                            # existing — reference image
```
